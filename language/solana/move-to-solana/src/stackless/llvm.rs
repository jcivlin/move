...
impl DIBuilder {
    ...
    /// This should be called at the end of debug generation before outputing the debug_info file
    ///
    /// Note to DIBuilder developer: use the same pattern in other functions:
    /// check Some(x) = &self.0 and do someting or do nothing otherwise.
